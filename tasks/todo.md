# WeChat to Blog Publishing: https://mp.weixin.qq.com/s/54xGXJkIuAIJyaMwrCzZsA

- [x] Scrape the WeChat article to extract the Chinese title, content, and image URLs.
- [x] Determine a short, URL-friendly English slug for the article.
